...
class WaitRequestEditor extends Component {
  ...
  getFormClass(key) {
    ...
    return formSubmitted === true &&
      typeof validations[key] !== "undefined" &&
  ...
  handleSubmitForm = (event) => {
    ...
    const { waitRequestID, selections, validations, waitRequestData } =
      this.state;
    let isValid = true;
    const selectionKeys = Object.keys(selections);
    selectionKeys.forEach((key) => {
      if (
        (selections[key] === "" || selections[key] === null) &&
        key !== "color" &&
        key !== "note"
      ) {
        isValid = false;
      ...
      if (waitRequestID === "") {
        const createData = {
          firstName: `${firstName
            .trim()
            .substring(0, 1)
            .toUpperCase()}${firstName.trim().substring(1)}`,
          lastName: `${lastName.trim().substring(0, 1).toUpperCase()}${lastName
            .trim()
            .substring(1)}`,
          email: email.trim(),
          phone: phone.trim(),
          city: `${selections.city
            .trim()
            .substring(0, 1)
            .toUpperCase()}${selections.city.trim().substring(1)}`,
          state: state,
          color: color.trim(),
  ...
  handleUndoClicked = () => {
    ...
    selections.note = note !== undefined ? note : "";
    selections.color = color !== undefined ? color : "";
    selections.expectedPurchaseDate =
      expectedPurchaseDate !== undefined
  ...
  render() {
    const { waitRequestID, selections, validations, formSubmitted } =
      this.state;
    const {
      firstName,
      lastName,
      ...
      <div className="card">
        <form noValidate>
              ...
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-control ${this.getFormClass("firstName")}`}
                    value={firstName}
              ...
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-control ${this.getFormClass("lastName")}`}
                    value={lastName}
              ...
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-control ${this.getFormClass("email")}`}
                    value={email}
              ...
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-control ${this.getFormClass("phone")}`}
                    value={phone}
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-control ${this.getFormClass("city")}`}
                    value={city}
              ...
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <select
                    className={`form-control ${this.getFormClass("state")}`}
                    value={state}
            ...
            <div className="row">
              <div className="col-12">
                <div className="form-group">
                  ...
                  <textarea
                    row="4"
                    className={`form-control ${this.getFormClass("message")}`}
                    placehodler="Enter your message"
                    value={message}
              ...
              <div className="col-12">
                <div className="form-group">
                  ...
                  <textarea
                    row="4"
                    className="form-control"
                    placehodler="Note about the wait request"
                    value={note}
                    onChange={this.handleSetNote}
                  ></textarea>
                </div>
              </div>
            </div>
          ...
          <div className="card-footer">
            ...
            <Link to="/wait-list" className="btn btn-secondary ml-1">
              Cancel
            </Link>
          </div>
        </form>
