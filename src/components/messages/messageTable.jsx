...
class MessageTable extends Component {
      ...
      return messages.map((message) => {
        ...
        return (
          <Link
            ...
            to={{
              pathname: `/wait-list/${message.waitRequestID}`,
              state: { prevPathname: "/messages" },
            }}
            className="c-message"
          >
  ...
  render() {
    const { currentPage, totalItems, maxPages, pageSize } =
      ...
      <div className="animated fadeIn">
        <div className="card c-email-app">
          <div className="card-body">
            ...
            <div className="c-messages">{this.renderMessageList()}</div>
          </div>
        </div>
      </div>
    );
