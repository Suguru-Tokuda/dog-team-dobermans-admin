...
class Login extends Component {
  ...
  constructor(props) {
    ...
    if (Cookies.get("rememberMe")) {
      this.state.rememberMe =
        Cookies.get("rememberMe") === "true" ? true : false;
    }
  ...
  handleLoginBtnClicked = async () => {
    ...
    if (
      email.toLowerCase() !== "suguru.tokuda@gmail.com" &&
      email.toLowerCase() !== "omegarlj@yahoo.com"
    ) {
  ...
  handleSubmitByEnter = (e) => {
    if (e.key === "Enter") this.handleLoginBtnClicked();
  };
