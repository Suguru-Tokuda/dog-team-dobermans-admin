...
class ImageCropModal extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (
      nextProps.imageFile !== prevState.imageFile ||
      (typeof nextProps.aspectRatio !== "undefined" &&
        nextProps.aspectRatio !== prevState.aspectRatio)
    ) {
  ...
  handleCropBtnClicked = () => {
    ...
    if (croppedURL !== null && croppedURL !== "") {
      ...
      fetch(croppedURL).then((res) => {
        res
          .blob()
          .then(async (blobFile) => {
            const newFile = new File([blobFile], "new_picture", {
              type: "image/png",
            });
            try {
              const options = {
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button
                ...
                onClick={this.handleCancelBtnClicked}
              >
                Cancel
              </button>
              <button
              ...
              <button
                ...
                disabled={croppedURL === "" || croppedURL === null}
                onClick={this.handleCropBtnClicked}
              >
                Finish
              </button>
            </div>
