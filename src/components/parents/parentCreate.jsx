...
class ParentCreate extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Route path={`${url}/initial-params`} render={(props) => <ParentInitialForm {...props} initialParams={this.state.initialParams} onShowLoading={this.props.onShowLoading.bind(this)} onDoneLoading={this.props.onDoneLoading.bind(this)} onToPictureBtnClicked={this.handleNextBtnClicked.bind(this)} />} />
